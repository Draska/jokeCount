new Vue({
    ...
    methods: {
        ...
        parseJoker: function(joker) {
            this.jokersPlace += `<a href="#!" class="collection-item"><span class="badge"><a class="waves-effect waves-teal btn-flat btn-small" v-on:click="addThisJoke(${joker.name})">+</a>${joker.jokes}</span>${emojione.toImage(joker.name)}</a>`
        }
    }
});
